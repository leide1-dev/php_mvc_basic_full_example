...
class Student extends Model {
    ...
    public function create($data) {
        $stmt = $this->db->prepare("
            INSERT INTO students (name, lastname, sex, date_born, country_id)
            VALUES (:name, :lastname, :sex, :date_born, :country_id)
        ");
        return $stmt->execute([
            ':name' => $data['name'],
    ...
    public function update($id, $column, $value) {
        $allowed = ['name', 'lastname', 'sex', 'date_born', 'country_id'];
